main.cas: main.c graphics.h graphics.asm graphics.c games.h utils.c utils.h keyboard.c keyboard.h game_of_life.c game_of_life.asm game_of_ur.c tetris.c countries.c typing.c reaction_test.c hangman.c walker.c
	zcc +p2000 -O3 -SO3 -DAMALLOC --max-allocs-per-node20000 --list --c-code-in-asm -compiler=sdcc -o main \
	main.c graphics.c graphics.asm utils.c keyboard.c game_of_life.c game_of_life.asm game_of_ur.c tetris.c countries.c typing.c reaction_test.c hangman.c walker.c \
	-create-app
